		...
		switch (_p2.ctor) {
			...
			case 'Warning':
				return A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-bubblegum-warn', _p2._0),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
				...
				return A2(
					...
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							_flarebyte$bubblegum_ui_tag$Bubblegum_Preview_BulmaHelper$getWarningMessage(outcomeTextType)),
						_1: {ctor: '[]'}
					});
		}
	});
